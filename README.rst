...
.. image:: https://img.shields.io/badge/license-Apache--2.0-blue.svg
    ...
    :target: https://github.com/bechtoldt/saltstack-grub-formula/blob/master/LICENSE

.. image:: https://img.shields.io/badge/gitter-chat-brightgreen.svg
    :alt: Join Chat
    :target: https://gitter.im/bechtoldt/saltstack-grub-formula?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge

SaltStack Formula to set up and configure Grub, a Multiboot boot loader
...
Take a look at older `releases <https://github.com/bechtoldt/saltstack-grub-formula/releases>`_ to get a version that isn't using the formhelper
yet (if any).
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-grub-formula/issues/new>`_ with your idea first.
